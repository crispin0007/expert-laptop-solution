...
from parties.services import resolve_or_create_customer_party, resolve_or_create_supplier_party


class Command(BaseCommand):
    help = 'Backfill Party records from existing Customer and Supplier profiles (idempotent).'
