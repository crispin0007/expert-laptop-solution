...
export default function CreateDepartmentModal({ open, onClose }: Props) {
  ...
  const mutation = useMutation({
    mutationFn: (payload: Record<string, unknown>) => apiClient.post('/departments/', payload),
    onSuccess: () => {
  ...
  function handleSubmit(e: React.FormEvent) {
    ...
    mutation.mutate({
      ...
      ...(form.head ? { head: Number(form.head) } : {}),
    })
  }
  ...
  return (
    <Modal open={open} onClose={handleClose} title="Create Department" width="max-w-md">
